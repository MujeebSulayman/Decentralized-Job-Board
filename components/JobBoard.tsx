                ...
                <div className='flex flex-wrap gap-2'>
                    {jobCategories.map((filter) => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 whitespace-nowrap ${activeFilter === filter.toLowerCase()
                            ...
                            <div className='flex items-center justify-between'>
                                ...
                                <div className='flex items-center space-x-4 ml-4 flex-shrink-0'>
                                    <div className='flex flex-col items-end'>
                                        ...
                                        <span
                                            className={`mt-1 px-3 py-1 text-xs rounded-full ${Number(job.isOpen)
