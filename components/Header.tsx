              ...
              <div className="pt-5 pb-6 px-5">
                ...
                <div className="mt-6">
                  <nav className="grid gap-y-4">
                    <NavLink href="/jobs" mobile>Verified Jobs</NavLink>
                    <NavLink href="/post-job" mobile>Create Listing</NavLink>
                    <NavLink href="/applications" mobile>Job Applications</NavLink>
                  </nav>
                </div>
              </div>
            </div>
