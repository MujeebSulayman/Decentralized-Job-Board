...
const EmployerDashboardLayout: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => {
  ...
  const [employerRole, setEmployerRole] = useState("EMPLOYER");
  ...
  useEffect(() => {
    // Fetch metrics on client-side to avoid hydration issues
      ...
      <div className="flex-1 min-w-0 flex flex-col overflow-hidden">
        ...
        <div className="lg:hidden">
          <div className="bg-black/90 py-2 px-4 flex items-center justify-between sm:px-6 lg:px-8 border-b border-gray-800/30">
            ...
            <h1 className="text-lg font-medium text-white">Employer Dashboard</h1>
            {address && (
