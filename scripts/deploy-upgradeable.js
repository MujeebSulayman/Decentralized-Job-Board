...
async function main() {
  ...
  console.log(`Deploying upgradeable JobBoard to ${network.name} (chainId: ${network.chainId})...\n`);
  ...
  try {
    ...
    console.log('  - Implementation can be upgraded without losing data');
